...
TTITLE TAB 50 'Employee Staff Information'
...
BREAK ON stf_gender SKIP PAGE ON REPORT 
...
ACCEPT selection default 'STF_Gender, STF_Lname, STF_Fname, Staff_ID, STF_Home_Phone, Position, STF_Cell_Phone, Work_area, STF_address, STF_DoB, Hrs_Per_Week, Payment_type, Contract_type, STF_Ward_num' PROMPT 'Enter your selection fields: '
ACCEPT view_name default 'emp_info' PROMPT 'Enter name of view: '

CREATE VIEW &view_name AS 
SELECT &selection
FROM STAFF
ORDER BY stf_gender ASC;
